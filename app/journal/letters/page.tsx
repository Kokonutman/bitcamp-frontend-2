import { LetterTool } from "@/components/letter-tool";
      ...
      <div className="relative px-6 py-12 w-full">
        ...
        <div className="mx-auto max-w-2xl space-y-12">
          <header className="text-center animate-fade-in">
            <h1 className="text-4xl font-bold text-foreground/90 mb-2 font-heading">Recovery Letters</h1>
            <p className="text-lg text-muted-foreground">Write to your past and future self</p>
          </header>
