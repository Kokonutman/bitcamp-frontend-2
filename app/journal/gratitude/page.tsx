  ...
  return (
    <main className="min-h-screen relative flex items-center">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1502657877623-f66bf489d236?q=80&w=2000&auto=format&fit=crop")',
          zIndex: -1,
        }}
      />
      ...
      <div className="relative px-6 py-12 w-full">
        ...
        <div className="mx-auto max-w-2xl space-y-12">
          <header className="text-center animate-fade-in">
            <h1 className="text-4xl font-bold text-foreground/90 mb-2 font-heading">
              Gratitude Journal
            </h1>
